          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white border-2 border-gray-200 p-10 rounded-lg">
              ...
              <p className="text-xs text-charcoal/60 mt-6">
                <strong>Note:</strong> For reservations, please use our <Link href="/reservations" className="text-warm-brown hover:underline">reservations page</Link> or call us directly.
              </p>
            </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-white/10 p-4 rounded">
                    <p className="text-sm text-white/80">
                      <strong className="text-white">Kitchen closes at 9PM</strong><br />
